...
class Book:
    def __init__(self, title:str, author:str, editor:str, page_nbr:int, year_published:int, type:BookType, genre:NovelGenre):
        if not title.strip():
...
class ReadingRecord():
    ...
    def __repr__(self):
        if self.is_read and self.end_date != None:
